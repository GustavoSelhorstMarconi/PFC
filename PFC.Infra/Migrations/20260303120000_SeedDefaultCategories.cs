...
namespace PFC.Infra.Migrations
{
    ...
    public partial class SeedDefaultCategories : Migration
    {
        ...
        {
            // 1. Torna UserId opcional para suportar categorias padrão do sistema
            ...
            // 3. Índice parcial único para garantir que não haja nomes duplicados nas categorias padrão
            migrationBuilder.Sql(
                @"CREATE UNIQUE INDEX ""IX_Categories_Name_Default"" ON ""Categories"" (""Name"") WHERE ""UserId"" IS NULL");
