    ...
    public partial class SeederCategory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            VALUES
                ...
                ('11111111-1111-1111-1111-111111111115', NULL, 'Imposto',      'Expense', '#6C1413', NULL,   true, true, '2026-03-03T12:00:00Z'),
                ('11111111-1111-1111-1111-111111111116', NULL, 'Outros',       'Expense', '#2E2E2E', NULL,   true, true, '2026-03-03T12:00:00Z'),
                -- Receitas
                ('11111111-1111-1111-1111-111111111117', NULL, 'Salário',      'Income',  '#2ECC71', '💰',   true, true, '2026-03-03T12:00:00Z'),
                ('11111111-1111-1111-1111-111111111118', NULL, 'Freelance',    'Income',  '#1ABC9C', '💻',   true, true, '2026-03-03T12:00:00Z'),
                ('11111111-1111-1111-1111-111111111119', NULL, 'Investimentos','Income',  '#16A085', '📈',   true, true, '2026-03-03T12:00:00Z'),
                ('11111111-1111-1111-1111-111111111120', NULL, 'Rendimentos',  'Income',  '#27AE60', '💵',   true, true, '2026-03-03T12:00:00Z'),
                ('11111111-1111-1111-1111-111111111121', NULL, 'Outros',       'Income',  '#95A5A6', '➕',   true, true, '2026-03-03T12:00:00Z'),
                ('11111111-1111-1111-1111-111111111122', NULL, 'Reembolso',    'Income',  '#46295A', NULL,   true, true, '2026-03-03T12:00:00Z');
            ");
        }
